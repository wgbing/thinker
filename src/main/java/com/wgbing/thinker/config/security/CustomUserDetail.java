...
public class CustomUserDetail implements UserDetails, CredentialsContainer {
    ...
    private User user;
    private final Map<String,Object> additionMap;

    public CustomUserDetail(String username, String password, Collection<? extends GrantedAuthority> authorities) {
        this(username, password, true, true, true, true, authorities, null, null);
    }

    public CustomUserDetail(String username, String password, boolean enabled, boolean accountNonExpired, boolean credentialsNonExpired, boolean accountNonLocked, Collection<? extends GrantedAuthority> authorities, User user, Map<String,Object> additionMap) {
    ...
    private static SortedSet<GrantedAuthority> sortAuthorities(Collection<? extends GrantedAuthority> authorities) {
        ...
        TreeSet sortedAuthorities = new TreeSet(new CustomUserDetail.AuthorityComparator());
